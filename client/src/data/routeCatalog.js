export const canonicalFrameRoutes = [
  ...
  { title: 'Admin Dashboard 1', path: '/admin/dashboard', note: 'Figma slug: admin-dashboard-1', slug: 'admin-dashboard-1' },
  { title: 'Admin Dashboard 2', path: '/admin/sales', note: 'Figma slug: admin-dashboard-2', slug: 'admin-dashboard-2' },
  { title: 'Admin Dashboard 3', path: '/admin/creators', note: 'Figma slug: admin-dashboard-3', slug: 'admin-dashboard-3' },
  { title: 'Admin Dashboard 4', path: '/admin/asset-approval', note: 'Figma slug: admin-dashboard-4', slug: 'admin-dashboard-4' },
  { title: 'Upload Asset 1', path: '/admin/upload-asset', note: 'Figma slug: upload-asset-1', slug: 'upload-asset-1' },
  { title: 'Upload Asset 2', path: '/admin/upload-asset/review', note: 'Figma slug: upload-asset-2', slug: 'upload-asset-2' },
  ...
  { title: 'Admin Dashboard 5', path: '/admin/reports', note: 'Figma slug: admin-dashboard-5', slug: 'admin-dashboard-5' },
